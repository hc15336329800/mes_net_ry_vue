  ...
  <div class="container">
    <el-row :gutter="20" style="height: 100%;">
      ...
      <el-col :span="4" style="height: 100%;">
        ...
        <div class="flexVertical" style="background-color: #FFFFFF; height: 100%;   padding: 0px;">

          <!-- 卡片 -->
          <el-card class="aa" :style="{ '--card-header-bg': theme ,flex: 1}" shadow="never">
            <!-- 卡片头 -->
            <div slot="header" class="card-header clearfix">
              <span>  <span style="color: #00D7FB">| </span> 设备分类</span>
            </div>
            <!-- 卡片体 -->
            <!-- 树结构 -->
            <div class="flexBoxHorizontal" style="flex: 1; overflow: auto; width: 100%; margin-top: 10px;">
              <el-tree
                ref="tree"
                :data="treeData"
                :props="defaultProps"
      ...
      <!-- 右侧 -->
      <el-col :span="20" style="background-color: #FFFFFF; height: 100%;   padding:10px;">

        <div style="height: 300px; width: 100%" class="flexHorizontalSco">
          <!-- 动态遍历逆变器数据 -->
          ...
          >
            ...
            <div class="flexHorizontal"
                 style="background-color: #e5f6f4; justify-content: space-between; height: 36px; padding: 3px 10px;"
            >
            ...
            <!-- 两行结构 -->
            <div class="flexHorizontal" style="height: 80%">
              <!-- 内一列：图片 -->
              ...
              <div style="flex: 4; height: 100%">
                <div class="flexVertical_betweenn" style="height: 100%">
